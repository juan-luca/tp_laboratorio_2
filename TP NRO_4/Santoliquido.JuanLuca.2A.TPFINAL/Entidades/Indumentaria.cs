...
namespace Entidades
{
    public abstract class Indumentaria : IPrenda
    {
        ...
        public Indumentaria(int T1, int T2, int T3, int T4, int T5, EPrenda tipo, EMarca marca, string modelo, string variante) : this()
        {
        ...
        /// <param name="modelo">Modelo</param>
        /// <param name="variante">Variante</param>
        public Indumentaria(int id,int T1, int T2, int T3, int T4, int T5, EPrenda tipo, EMarca marca, string modelo, string variante) : this(T1,T2,T3,T4,T5,tipo,marca,modelo,variante)
        {
            this.id = id;
