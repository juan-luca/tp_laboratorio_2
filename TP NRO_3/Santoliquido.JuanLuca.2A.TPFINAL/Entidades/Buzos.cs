...
namespace Entidades
{
    public class Buzos : Indumentaria
    {
        ...
        public Buzos(int T1, int T2, int T3, int T4, int T5, bool Capucha, enumMarca marca, string modelo) : base(T1, T2, T3, T4, T5, enumPrenda.Buzo, marca, modelo, Capucha ? "Con capucha" : "Sin capucha")
        {
        ...
        /// <param name="modelo">Modelo</param>
        /// <param name="variante">Variante</param>
        public Buzos(int id,int T1, int T2, int T3, int T4, int T5, bool Capucha, enumMarca marca, string modelo) : base(id,T1, T2, T3, T4, T5, enumPrenda.Buzo, marca, modelo, Capucha ? "Con capucha" : "Sin capucha")
        {
