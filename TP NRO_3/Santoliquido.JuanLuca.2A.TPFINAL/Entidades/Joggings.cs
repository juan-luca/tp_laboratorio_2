...
namespace Entidades
{
    public class Joggings : Indumentaria
    {
        ...
        public Joggings(int T1, int T2, int T3, int T4, int T5, bool Punio, enumMarca marca, string modelo) : base(T1, T2, T3, T4, T5, enumPrenda.Jogging, marca, modelo, Punio ? "Con punio" : "Sin punio")
        {
        ...
        /// <param name="modelo">Modelo</param>
        /// <param name="variante">Variante</param>
        public Joggings(int id,int T1, int T2, int T3, int T4, int T5,bool Punio, enumMarca marca, string modelo) :base(id,T1,T2,T3,T4,T5,enumPrenda.Jogging, marca,modelo,Punio ? "Con punio" : "Sin punio")
        {
